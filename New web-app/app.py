...
DEFAULT_STATIC_IMAGE = r"C:\Drive F\Code\Project\IWeb-app-Indian-Sign-Language-To-Multiple-Regional-Language-Conversion - Copy\New web-app\static\impact-of-ai-sign-language-translators.png"  # Add this path
