...
class MainWindow(QMainWindow):
    ...
    def translate_sentence(self):
        ...
        Construct a coherent {lang_name} sentence a person might communicate.
        If the gestures include words like "What" or "When", form a natural and clear question.
        Otherwise, create a normal sentence.
        Use simple and clear grammar suitable for daily life, medical, or work-related contexts.
        Respond only with the sentence in {lang_name}.
